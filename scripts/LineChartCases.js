...
async function drawChart(type) {
  ...
  let figures = google.visualization.arrayToDataTable(arrCases);

  // Define the chart type (LineChart) and the container (a DIV in our case).
  let chart = new google.charts.Line(document.getElementById('line-chart-' + type.toLowerCase()));
